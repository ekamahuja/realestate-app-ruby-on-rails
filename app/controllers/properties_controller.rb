class PropertiesController < ApplicationController
  ...
  before_action :authenticate_account!, only: [:new, :create, :destroy, :update, :edit]
  ...
  private
    ...
    def property_params
      params.require(:property).permit(:name, :address, :price, :rooms, :bathrooms, :parking_spaces, :description, :for_sale, :photo, :avaliable_date)
    end
